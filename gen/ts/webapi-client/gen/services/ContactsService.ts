...
/* tslint:disable */
/* eslint-disable */
import type { ContactArchiveArgs } from '../models/ContactArchiveArgs';
import type { ContactCreateArgs } from '../models/ContactCreateArgs';
import type { ContactCreateResult } from '../models/ContactCreateResult';
import type { ContactFindArgs } from '../models/ContactFindArgs';
import type { ContactFindResult } from '../models/ContactFindResult';
import type { ContactLinkUpsertArgs } from '../models/ContactLinkUpsertArgs';
import type { ContactLinkUpsertResult } from '../models/ContactLinkUpsertResult';
import type { ContactLoadArgs } from '../models/ContactLoadArgs';
...
export class ContactsService {
    ...
    public contactArchive(
        requestBody?: ContactArchiveArgs,
    ...
    public contactCreate(
        requestBody?: ContactCreateArgs,
    ): CancelablePromise<ContactCreateResult> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/contact-create',
            body: requestBody,
     ...
     */
    public contactFind(
        requestBody?: ContactFindArgs,
    ): CancelablePromise<ContactFindResult> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/contact-find',
            body: requestBody,
     ...
     */
    public contactLoad(
        requestBody?: ContactLoadArgs,
    ): CancelablePromise<ContactLoadResult> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/contact-load',
            body: requestBody,
     ...
     * @throws ApiError
     */
    public contactLinkUpsert(
        requestBody?: ContactLinkUpsertArgs,
    ): CancelablePromise<ContactLinkUpsertResult> {
        return this.httpRequest.request({
            method: 'POST',
