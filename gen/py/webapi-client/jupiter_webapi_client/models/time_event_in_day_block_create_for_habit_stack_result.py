...
T = TypeVar("T", bound="TimeEventInDayBlockCreateForHabitStackResult")


@_attrs_define
class TimeEventInDayBlockCreateForHabitStackResult:
    """Result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_event_in_day_block_create_for_habit_stack_result = cls(
            new_time_events=new_time_events,
        )

        time_event_in_day_block_create_for_habit_stack_result.additional_properties = d
        return time_event_in_day_block_create_for_habit_stack_result
