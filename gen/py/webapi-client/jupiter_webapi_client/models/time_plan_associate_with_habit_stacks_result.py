...
T = TypeVar("T", bound="TimePlanAssociateWithHabitStacksResult")


@_attrs_define
class TimePlanAssociateWithHabitStacksResult:
    """Result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_with_habit_stacks_result = cls(
            new_time_plan_activities=new_time_plan_activities,
        )

        time_plan_associate_with_habit_stacks_result.additional_properties = d
        return time_plan_associate_with_habit_stacks_result
