...
T = TypeVar("T", bound="TimePlanAssociateWithHabitStacksArgs")


@_attrs_define
class TimePlanAssociateWithHabitStacksArgs:
    """Args.

    Attributes:
        ref_id (str): A generic entity id.
        habit_stack_ref_ids (list[str]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        habit_stack_ref_ids = self.habit_stack_ref_ids
        ...
        field_dict.update(
            {
                "ref_id": ref_id,
                "habit_stack_ref_ids": habit_stack_ref_ids,
                "kind": kind,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_stack_ref_ids = cast(list[str], d.pop("habit_stack_ref_ids"))

        kind = TimePlanActivityKind(d.pop("kind"))

        feasability = TimePlanActivityFeasability(d.pop("feasability"))

        time_plan_associate_with_habit_stacks_args = cls(
            ref_id=ref_id,
            habit_stack_ref_ids=habit_stack_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_with_habit_stacks_args.additional_properties = d
        return time_plan_associate_with_habit_stacks_args
