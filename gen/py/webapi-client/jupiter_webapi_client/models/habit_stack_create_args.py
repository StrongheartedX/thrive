...
T = TypeVar("T", bound="HabitStackCreateArgs")


@_attrs_define
class HabitStackCreateArgs:
    """Habit stack creation parameters.

    Attributes:
        name (str): The habit stack name.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_stack_create_args.additional_properties = d
        return habit_stack_create_args
