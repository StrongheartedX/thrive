...
T = TypeVar("T", bound="ChoreStackLoadArgs")


@_attrs_define
class ChoreStackLoadArgs:
    """ChoreStackLoadArgs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chore_stack_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        chore_stack_load_args.additional_properties = d
        return chore_stack_load_args
