...
T = TypeVar("T", bound="HabitStackFindResultEntry")


@_attrs_define
class HabitStackFindResultEntry:
    ...
    habits: list[Habit] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_habits(data: object) -> list[Habit] | None | Unset:
            if data is None:
                return data
        ...
        habit_stack_find_result_entry = cls(
            habit_stack=habit_stack,
            tags=tags,
            contacts=contacts,
            owner=owner,
        ...
        habit_stack_find_result_entry.additional_properties = d
        return habit_stack_find_result_entry
