...
T = TypeVar("T", bound="ScheduleEventInDayUpdateResult")


@_attrs_define
class ScheduleEventInDayUpdateResult:
    """ScheduleEventInDayUpdate result.

    Attributes:
        updated_schedule_event_in_day (ScheduleEventInDay): An event in a schedule.
    ...
    def to_dict(self) -> dict[str, Any]:
        updated_schedule_event_in_day = self.updated_schedule_event_in_day.to_dict()
        ...
        field_dict.update(
            {
                "updated_schedule_event_in_day": updated_schedule_event_in_day,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        updated_schedule_event_in_day = ScheduleEventInDay.from_dict(d.pop("updated_schedule_event_in_day"))

        updated_time_event_in_day_block = TimeEventInDayBlock.from_dict(d.pop("updated_time_event_in_day_block"))

        schedule_event_in_day_update_result = cls(
            updated_schedule_event_in_day=updated_schedule_event_in_day,
            updated_time_event_in_day_block=updated_time_event_in_day_block,
        )

        schedule_event_in_day_update_result.additional_properties = d
        return schedule_event_in_day_update_result
