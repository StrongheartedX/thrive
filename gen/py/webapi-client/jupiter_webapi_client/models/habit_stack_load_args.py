...
T = TypeVar("T", bound="HabitStackLoadArgs")


@_attrs_define
class HabitStackLoadArgs:
    """HabitStackLoadArgs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_stack_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        habit_stack_load_args.additional_properties = d
        return habit_stack_load_args
