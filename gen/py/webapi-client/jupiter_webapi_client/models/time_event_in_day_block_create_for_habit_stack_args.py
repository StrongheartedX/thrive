...
T = TypeVar("T", bound="TimeEventInDayBlockCreateForHabitStackArgs")


@_attrs_define
class TimeEventInDayBlockCreateForHabitStackArgs:
    """Args.

    Attributes:
        habit_stack_ref_id (str): A generic entity id.
    ...
    def to_dict(self) -> dict[str, Any]:
        habit_stack_ref_id = self.habit_stack_ref_id
        ...
        field_dict.update(
            {
                "habit_stack_ref_id": habit_stack_ref_id,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        habit_stack_ref_id = d.pop("habit_stack_ref_id")
        ...
        time_event_in_day_block_create_for_habit_stack_args = cls(
            habit_stack_ref_id=habit_stack_ref_id,
            start_date=start_date,
            start_time_in_day=start_time_in_day,
            duration_mins=duration_mins,
        ...
        time_event_in_day_block_create_for_habit_stack_args.additional_properties = d
        return time_event_in_day_block_create_for_habit_stack_args
