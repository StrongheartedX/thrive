...
T = TypeVar("T", bound="TimePlanAssociateWithChoreStacksArgs")


@_attrs_define
class TimePlanAssociateWithChoreStacksArgs:
    """Args.

    Attributes:
        ref_id (str): A generic entity id.
        chore_stack_ref_ids (list[str]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        chore_stack_ref_ids = self.chore_stack_ref_ids
        ...
        field_dict.update(
            {
                "ref_id": ref_id,
                "chore_stack_ref_ids": chore_stack_ref_ids,
                "kind": kind,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chore_stack_ref_ids = cast(list[str], d.pop("chore_stack_ref_ids"))

        kind = TimePlanActivityKind(d.pop("kind"))

        feasability = TimePlanActivityFeasability(d.pop("feasability"))

        time_plan_associate_with_chore_stacks_args = cls(
            ref_id=ref_id,
            chore_stack_ref_ids=chore_stack_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_with_chore_stacks_args.additional_properties = d
        return time_plan_associate_with_chore_stacks_args
