...
T = TypeVar("T", bound="TimePlanAssociateHabitStackWithPlanArgs")


@_attrs_define
class TimePlanAssociateHabitStackWithPlanArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_habit_stack_with_plan_args = cls(
            habit_stack_ref_id=habit_stack_ref_id,
            time_plan_ref_ids=time_plan_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_habit_stack_with_plan_args.additional_properties = d
        return time_plan_associate_habit_stack_with_plan_args
