...
T = TypeVar("T", bound="TimePlanActivityLoadForPanelResult")


@_attrs_define
class TimePlanActivityLoadForPanelResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        stack_inbox_tasks = []
        for stack_inbox_tasks_item_data in self.stack_inbox_tasks:
            stack_inbox_tasks_item = stack_inbox_tasks_item_data.to_dict()
            stack_inbox_tasks.append(stack_inbox_tasks_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stack_inbox_tasks = []
        _stack_inbox_tasks = d.pop("stack_inbox_tasks")
        for stack_inbox_tasks_item_data in _stack_inbox_tasks:
            stack_inbox_tasks_item = InboxTask.from_dict(stack_inbox_tasks_item_data)
        ...
        time_plan_activity_load_for_panel_result = cls(
            time_plan_activity=time_plan_activity,
            time_event_blocks=time_event_blocks,
            stack_inbox_tasks=stack_inbox_tasks,
        ...
        time_plan_activity_load_for_panel_result.additional_properties = d
        return time_plan_activity_load_for_panel_result
