...
T = TypeVar("T", bound="HabitStackLoadResult")


@_attrs_define
class HabitStackLoadResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_stack_load_result.additional_properties = d
        return habit_stack_load_result
