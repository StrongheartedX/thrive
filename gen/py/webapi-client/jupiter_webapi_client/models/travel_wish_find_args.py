...
T = TypeVar("T", bound="TravelWishFindArgs")


@_attrs_define
class TravelWishFindArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        travel_wish_find_args = cls(
            allow_archived=allow_archived,
            include_tags=include_tags,
            filter_ref_ids=filter_ref_ids,
        )

        travel_wish_find_args.additional_properties = d
        return travel_wish_find_args
