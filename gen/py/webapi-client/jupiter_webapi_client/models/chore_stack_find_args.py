...
T = TypeVar("T", bound="ChoreStackFindArgs")


@_attrs_define
class ChoreStackFindArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chore_stack_find_args.additional_properties = d
        return chore_stack_find_args
