...
T = TypeVar("T", bound="ChoreStackFindResultEntry")


@_attrs_define
class ChoreStackFindResultEntry:
    ...
    chores: list[Chore] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_chores(data: object) -> list[Chore] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for chores_type_0_item_data in _chores_type_0:
                    chores_type_0_item = Chore.from_dict(chores_type_0_item_data)
        ...
        chore_stack_find_result_entry = cls(
            chore_stack=chore_stack,
            tags=tags,
            contacts=contacts,
            owner=owner,
        ...
        chore_stack_find_result_entry.additional_properties = d
        return chore_stack_find_result_entry
