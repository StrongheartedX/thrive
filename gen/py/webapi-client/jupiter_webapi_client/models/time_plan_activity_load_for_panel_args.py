...
T = TypeVar("T", bound="TimePlanActivityLoadForPanelArgs")


@_attrs_define
class TimePlanActivityLoadForPanelArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_activity_load_for_panel_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        time_plan_activity_load_for_panel_args.additional_properties = d
        return time_plan_activity_load_for_panel_args
