...
T = TypeVar("T", bound="HabitStackFindArgs")


@_attrs_define
class HabitStackFindArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_stack_find_args.additional_properties = d
        return habit_stack_find_args
