...
T = TypeVar("T", bound="ChoreStackLoadResult")


@_attrs_define
class ChoreStackLoadResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chore_stack_load_result.additional_properties = d
        return chore_stack_load_result
