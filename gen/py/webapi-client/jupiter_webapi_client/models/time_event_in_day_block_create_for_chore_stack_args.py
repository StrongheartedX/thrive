...
T = TypeVar("T", bound="TimeEventInDayBlockCreateForChoreStackArgs")


@_attrs_define
class TimeEventInDayBlockCreateForChoreStackArgs:
    """Args.

    Attributes:
        chore_stack_ref_id (str): A generic entity id.
    ...
    def to_dict(self) -> dict[str, Any]:
        chore_stack_ref_id = self.chore_stack_ref_id
        ...
        field_dict.update(
            {
                "chore_stack_ref_id": chore_stack_ref_id,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        chore_stack_ref_id = d.pop("chore_stack_ref_id")
        ...
        time_event_in_day_block_create_for_chore_stack_args = cls(
            chore_stack_ref_id=chore_stack_ref_id,
            start_date=start_date,
            start_time_in_day=start_time_in_day,
            duration_mins=duration_mins,
        ...
        time_event_in_day_block_create_for_chore_stack_args.additional_properties = d
        return time_event_in_day_block_create_for_chore_stack_args
