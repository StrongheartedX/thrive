...
T = TypeVar("T", bound="TimePlanAssociateChoreStackWithPlanArgs")


@_attrs_define
class TimePlanAssociateChoreStackWithPlanArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_chore_stack_with_plan_args = cls(
            chore_stack_ref_id=chore_stack_ref_id,
            time_plan_ref_ids=time_plan_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_chore_stack_with_plan_args.additional_properties = d
        return time_plan_associate_chore_stack_with_plan_args
