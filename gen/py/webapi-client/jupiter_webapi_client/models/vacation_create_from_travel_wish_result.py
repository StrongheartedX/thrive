...
T = TypeVar("T", bound="VacationCreateFromTravelWishResult")


@_attrs_define
class VacationCreateFromTravelWishResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vacation_create_from_travel_wish_result = cls(
            new_vacation=new_vacation,
            new_time_event_block=new_time_event_block,
        )

        vacation_create_from_travel_wish_result.additional_properties = d
        return vacation_create_from_travel_wish_result
