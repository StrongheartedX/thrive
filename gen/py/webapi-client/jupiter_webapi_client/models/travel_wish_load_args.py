...
T = TypeVar("T", bound="TravelWishLoadArgs")


@_attrs_define
class TravelWishLoadArgs:
    """TravelWishLoadArgs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        travel_wish_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        travel_wish_load_args.additional_properties = d
        return travel_wish_load_args
