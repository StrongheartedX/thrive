...
import { VacationEditor } from "@jupiter/core/apps/vacations/sub/vacation/component/editor";
  ...
  try {
    ...
    return json({
      pageMeta: buildPublishedPageMeta({
        ...
        name: result.vacation.name,
        note: result.note,
        dateModified: result.vacation.last_modified_time,
      }),
