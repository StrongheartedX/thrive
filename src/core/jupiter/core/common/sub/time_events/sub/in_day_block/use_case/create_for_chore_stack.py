...
@use_case_args
class TimeEventInDayBlockCreateForChoreStackArgs(JupiterCreateLeafSupportEntityArgs):
    """Args."""
...
@use_case_result
class TimeEventInDayBlockCreateForChoreStackResult(UseCaseResultBase):
    """Result."""
...
@mutation_use_case()
class TimeEventInDayBlockCreateForChoreStackUseCase(
    JupiterCreateLeafSupportEntityUseCase[
    ...
    async def _perform_transactional_mutation(
        ...
        args: TimeEventInDayBlockCreateForChoreStackArgs,
    ) -> TimeEventInDayBlockCreateForChoreStackResult:
        """Execute the command's action."""
        chore_stack, owner_workspace_ref_id = await self.load_owner_entity(
            uow, context.user.ref_id, ChoreStack, args.chore_stack_ref_id
        )
        ...
        return TimeEventInDayBlockCreateForChoreStackResult(
