...
from jupiter.core.apps.life_plan.sub.aspects.root import (
    MAX_ASPECT_DEPTH_FROM_ROOT,
    Aspect,
)
from jupiter.core.apps.life_plan.sub.aspects.service.check_cycles import (
    AspectCheckCyclesService,
    AspectTreeHasCyclesError,
)
from jupiter.core.apps.life_plan.sub.aspects.service.compute_depth_from_root import (
    AspectComputeDepthFromRootService,
)
from jupiter.core.apps.life_plan.sub.aspects.service.replicate_aspect_hierarchy_rights import (
...
class AspectUpdateUseCase(
    ...
    async def _perform_transactional_mutation(
        ...
        parent_changed = (
            args.parent_aspect_ref_id.should_change
            and current_parent is not None
            and new_parent is not None
            and current_parent.ref_id != new_parent.ref_id
        )
