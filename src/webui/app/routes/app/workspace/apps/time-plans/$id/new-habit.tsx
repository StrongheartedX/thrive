...
import { CREATE_HABIT } from "@jupiter/core/apps/time_plans/store/mutations/create-entities";
...
// A new habit made from the time plan view, as a leaf of the plan rather than
// a trip to its app: making it doesn't reload the plan.
export default function TimePlanNewHabit() {
  ...
  return (
    <LeafPanel
      key={`time-plan-${id}/new-habit`}
      fakeKey={`time-plan-${id}/new-habit`}
