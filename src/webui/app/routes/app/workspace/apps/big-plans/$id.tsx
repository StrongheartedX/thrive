...
import { BigPlanMilestoneStack } from "@jupiter/core/apps/big_plans/sub/milestones/component/stack";
    ...
    switch (form.intent) {
      ...
      case "update": {
        ...
        if (result.record_score_result) {
          return redirect(`/app/workspace/apps/big-plans/${id}`, {
            headers: {
        ...
        return redirect(`/app/workspace/apps/big-plans`);
      }
          ...
          actions={
            <SectionActions
              ...
              actions={[
                NavSingle({
                  text: "New",
                  link: `/app/workspace/apps/big-plans/${loaderData.bigPlan.ref_id}/milestones/new`,
                }),
              ]}
            />
          }
          ...
          actions={
            <SectionActions
              ...
              actions={[
                NavSingle({
                  text: "New",
                  link: `/app/workspace/apps/big-plans/${loaderData.bigPlan.ref_id}/inbox-tasks/new`,
                }),
                FilterFewOptionsCompact(
                  "View",
                    ...
                    {EISENS.map((e) => (
                      <Fragment key={e}>
                        ...
                        <InboxTaskKanbanBoard
                          ...
                          cardLinkResolver={(it) =>
                            `/app/workspace/apps/big-plans/${loaderData.bigPlan.ref_id}/inbox-tasks/${it.ref_id}`
                          }
                        />
                      </Fragment>
                    ))}
                ...
                <SectionActions
                  ...
                  actions={[
                    NavSingle({
                      text: "Add",
                      highlight: false,
                      link: `/app/workspace/apps/time-plans/add-big-plan-to-plans?bigPlanRefId=${loaderData.bigPlan.ref_id}`,
                    }),
                  ]}
                />
              }
