...
export default function SmartLists() {
  ...
  return (
    <TrunkPanel
      key={"smart-lists"}
      createLocation="/app/workspace/apps/smart-lists/new"
        ...
        <EntityStack>
          {filteredEntries.length === 0 && (
            <EntityNoNothingCard
              ...
              newEntityLocations="/app/workspace/apps/smart-lists/new"
          ...
          {filteredEntries.map((entry) => (
            ...
            >
              ...
              />
              <EntityLink
                to={`/app/workspace/apps/smart-lists/${entry.smart_list.ref_id}`}
              >
