...
export default function Todos() {
  ...
  return (
    <TrunkPanel
      key={"todos"}
      createLocation="/app/workspace/apps/todos/new"
      ...
      <NestingAwareBlock shouldHide={shouldShowALeaf}>
        ...
        {sortedTodoTasks.length === 0 && (
          <EntityNoNothingCard
            ...
            newEntityLocations="/app/workspace/apps/todos/new"
          />
        )}
            ...
            {sortedTodoTasks.map((todoTask) => {
              ...
              return (
                ...
                >
                  ...
                  <EntityLink
                    to={`/app/workspace/apps/todos/${todoTask.ref_id}`}
                  >
              ...
              <DragDropContext onDragStart={onDragStart} onDragEnd={onDragEnd}>
                <InboxTaskKanbanBoard
                  ...
                  cardLinkResolver={(inboxTask, parent) =>
                    parent?.todoTask
                      ? `/app/workspace/apps/todos/${parent.todoTask.ref_id}`
          ...
          !isBigScreen && (
            <>
              <SmallScreenKanban
                ...
                emptyParentNewLocations="/app/workspace/apps/todos/new"
                cardLinkResolver={(inboxTask, parent) =>
                  parent?.todoTask
                    ? `/app/workspace/apps/todos/${parent.todoTask.ref_id}`
                    : `/app/workspace/core/inbox-tasks/${inboxTask.ref_id}`
...
function TodoSwiftView(props: TodoSwiftViewProps) {
  ...
  function renderBucket(
    ...
    const newEntityLocation = options?.initialDueDate
      ? `/app/workspace/apps/todos/new?initialDueDate=${options.initialDueDate}`
      : "/app/workspace/apps/todos/new";
    return (
      <>
        {showHeading && (
