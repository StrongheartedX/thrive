...
export default function DocsInFolder() {
      ...
      >
        <NestingAwareBlock shouldHide={shouldShowALeaf}>
          <Alert severity="warning">
            ...
            <Box sx={{ mt: 1 }}>
              <EntityLink
                to="/app/workspace/apps/docs/root-redirect"
                singleLine
              >
                My docs
              </EntityLink>
  ...
  const parentHref =
    parentDir != null
      ? `/app/workspace/apps/docs/${parentDir.ref_id}`
      : "/app/workspace/apps/docs";
  ...
  return (
    <TrunkPanel
      key={`docs-dir-${dirId}`}
      createLocation={
        inputsEnabled ? `/app/workspace/apps/docs/${dirId}/doc/new` : undefined
      }
      returnLocation="/app/workspace"
        ...
        <SectionActions
          ...
          actions={[
            NavSingle({
              id: "docs-new-folder",
              text: "New Folder",
              link: `/app/workspace/apps/docs/${dirId}/new`,
            ...
            ...(!isDirRoot(dirLoad.dir)
              ? [
                  NavSingle({
                    ...
                    text: "Settings",
                    link: `/app/workspace/apps/docs/${dirId}/settings`,
                    icon: <SettingsIcon />,
                  }),
                ]
              : []),
      ...
      <NestingAwareBlock shouldHide={shouldShowALeaf}>
        {listIsEmpty && !showParentLink && (
          <EntityNoNothingCard
            ...
            newEntityLocations={`/app/workspace/apps/docs/${dirId}/doc/new`}
              ...
              {sharedDirs.map((entry: DocsFindSharedDirEntry) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <EntityLink
                      to={`/app/workspace/apps/docs/${entry.dir.ref_id}`}
                      singleLine
                    >
                      <DocCardRoot>
                        <DocCardTitleRow>
              ...
              {sharedDocs.map((entry: DocsFindSharedDocEntry) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <EntityLink
                      to={`/app/workspace/apps/docs/${entry.doc.parent_dir_ref_id}/doc/${entry.doc.ref_id}`}
                      singleLine
                    >
                      <DocCardRoot>
                        <DocCardTitleRow>
          ...
          {sortedFilteredEntries.map((entry) => {
            ...
            return (
              ...
              >
                ...
                />
                <EntityLink
                  to={`/app/workspace/apps/docs/${dirId}/doc/${entry.doc.ref_id}`}
                  singleLine
                >
                  <DocCardRoot>
                    <DocCardTitleRow>
