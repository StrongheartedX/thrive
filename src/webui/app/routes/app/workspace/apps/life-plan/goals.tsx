...
import { sortGoalsNaturally } from "@jupiter/core/apps/life_plan/sub/goals/root";
        ...
        >
          {sortedGoals.length === 0 && (
            <EntityNoNothingCard
              ...
              newEntityLocations="/app/workspace/apps/life-plan/goals/new"
          ...
          <EntityStack>
            {sortedGoals.map((goal) => (
              ...
              >
                <EntityLink
                  to={`/app/workspace/apps/life-plan/goals/${goal.ref_id}`}
                >
                  <AspectTag
