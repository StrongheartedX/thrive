          ...
          actions={[
            NavMultipleCompact({
              navs: [
                NavSingle({
                  text: "Show No Goals",
                  link: `/app/workspace/apps/life-plan/history-of-work?${newURLParams(searchParams, "hideNoGoal", "false")}`,
                }),
                NavSingle({
                  text: "Hide No Goals",
                  link: `/app/workspace/apps/life-plan/history-of-work?${newURLParams(searchParams, "hideNoGoal", "true")}`,
                }),
              ],
            }),
          ]}
