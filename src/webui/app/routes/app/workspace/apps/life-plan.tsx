...
import {
  ...
  midDate,
} from "#/core/apps/life_plan/partial-date";
          ...
          actions={[
            NavMultipleSpread({
              navs: [
                ...
                NavSingle({
                  text: "New Goal",
                  link: `/app/workspace/apps/life-plan/goals/new`,
                  icon: <AddIcon />,
                }),
                NavSingle({
                  text: "New Milestone",
            ...
            NavMultipleCompact({
              navs: [
                NavSingle({
                  text: "",
                  link: `/app/workspace/apps/life-plan/settings`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "Vision History",
                  link: `/app/workspace/apps/life-plan/visions`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "Aspects",
                  link: `/app/workspace/apps/life-plan/aspects`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "Chapters",
                  link: `/app/workspace/apps/life-plan/chapters`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "Goals",
                  link: `/app/workspace/apps/life-plan/goals`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "Milestones",
                  link: `/app/workspace/apps/life-plan/milestones`,
                  icon: <TuneIcon />,
                }),
                NavSingle({
                  text: "History of Work",
                  link: `/app/workspace/apps/life-plan/history-of-work`,
                  icon: <HistoryIcon />,
                }),
              ],
            }),
                    ...
                    {sortedMilestones.length == 0 && (
                      <>
                        ...
                        <Button
                          ...
                          variant="contained"
                          component={Link}
                          to="/app/workspace/apps/life-plan/milestones/new"
                          sx={{ flexShrink: 0 }}
                        >
  ...
  return (
    ...
    >
      <EntityLink
        inline
        singleLine
        to={`/app/workspace/apps/life-plan/goals/${node.goal.ref_id}`}
      >
