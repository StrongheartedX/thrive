...
} from "@jupiter/core/apps/big_plans/root";
import type { BigPlanParent } from "@jupiter/core/apps/big_plans/root";
import { BigPlanStack } from "@jupiter/core/apps/big_plans/component/stack";
import { BigPlanTimelineBigScreen } from "@jupiter/core/apps/big_plans/component/timeline-big-screen";
import { BigPlanTimelineSmallScreen } from "@jupiter/core/apps/big_plans/component/timeline-small-screen";
...
export default function BigPlans() {
  ...
  return (
    <TrunkPanel
      key={"big-plans"}
      createLocation="/app/workspace/apps/big-plans/new"
      ...
      <NestingAwareBlock shouldHide={shouldShowALeaf || shouldShowALeaflet}>
        {sortedBigPlans.length === 0 && (
          <EntityNoNothingCard
            ...
            newEntityLocations="/app/workspace/apps/big-plans/new"
