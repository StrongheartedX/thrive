...
export default function ManageMcp() {
  ...
  return (
    <TrunkPanel key="manage-mcp" returnLocation="/app/workspace">
        ...
        <ToolPanel>
          <SectionCard title="MCP">
            <Typography variant="body1">
              ...
              <DocsHelp size="small" subject={DocsHelpSubject.MCP} />.
            </Typography>
          ...
          >
            <EntityStack>
              {loaderData.mcpKeys.map((mcpKey) => (
                ...
                >
                  <EntityLink to={`/app/workspace/manage-mcp/${mcpKey.ref_id}`}>
