...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const habitResponse = await apiClient.habits.habitLoad({
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    await apiClient.timeEvents.timeEventInDayBlockCreateForHabit({
      habit_ref_id: query.habitRefId,
...
export default function TimeEventInDayBlockCreateForHabit() {
