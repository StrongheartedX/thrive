...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const choreResponse = await apiClient.chores.choreLoad({
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    await apiClient.timeEvents.timeEventInDayBlockCreateForChore({
...
export default function TimeEventInDayBlockCreateForChore() {
