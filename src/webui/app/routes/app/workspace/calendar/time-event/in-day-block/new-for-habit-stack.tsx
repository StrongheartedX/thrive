...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const habitStackResponse = await apiClient.habits.habitStackLoad({
  ...
  return json({
    date: query.date,
    habitStack: habitStackResponse.habit_stack,
  });
}
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    await apiClient.timeEvents.timeEventInDayBlockCreateForHabitStack({
...
export default function TimeEventInDayBlockCreateForHabitStack() {
  ...
  const inputsEnabled =
    navigation.state === "idle" && !loaderData.habitStack.archived;
      ...
      >
        ...
        <FormControl fullWidth>
          ...
          <OutlinedInput
            label="name"
            name="name"
            defaultValue={loaderData.habitStack.name}
            readOnly={true}
          />
        </FormControl>
